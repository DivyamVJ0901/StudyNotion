  ...
  return (
    <div>
      ...
      >
        ...
        <div className='mx-3 my-12  shadow-[-0.1px_-2px_50px_0] text-blue-100'>
          <video
            muted
            loop
            autoPlay
            className='shadow-[15px_15px_0_0] text-white'
          >
      ...
      {/*Section 3 */}
      <div className='w-11/12 mx-auto relative my-20 max-w-maxContent flex flex-col items-center justify-between gap-8 first-letter bg-richblack-900 text-white'>
        <InstructorSection />
